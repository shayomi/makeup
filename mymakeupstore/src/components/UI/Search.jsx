    ...
    <div className="search">
      <div className="searchInputs flex flex-row gap-x-2 items-center">
        <input
          ...
          className="border border-gray-500 rounded-lg bg-transparent font-primary max-w-[150px] sm:w-[300px] md:max-w-[300px] md:w-[300px] h-[38px] px-3 py-2 focus:outline-none placeholder:text-[11px]"
        />
